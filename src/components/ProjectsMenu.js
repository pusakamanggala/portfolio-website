...
const ProjectsMenu = () => {
  ...
  return (
    <div className={`${dark && "dark"}`}>
      <div className="pt-40 bg-teal-500 dark:bg-slate-900">
        ...
        <div className="flex py-20 justify-center ">
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:max-w-4xl w-full">
            <div className="w-72 h-96 bg-slate-400 rounded-2xl mx-auto relative overflow-hidden">
              ...
              <h1 className="w-full  bg-slate-900 dark:bg-teal-300 absolute bottom-0 p-3 text-white font-semibold dark:text-slate-900">
